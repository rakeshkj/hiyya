...
class BxMatchPrivacy extends BxDolPrivacy
{
    var $oModule;
     ...
     * Constructor
     */
    function BxMatchPrivacy(&$oModule)
    {
    ...
    /**
     * Check whethere viewer is a member of dynamic match.
     *
     * @param  mixed   $mixedGroupId   dynamic match ID.
