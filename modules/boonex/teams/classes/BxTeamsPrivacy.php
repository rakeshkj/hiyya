...
class BxTeamsPrivacy extends BxDolPrivacy
{
    var $oModule;
     ...
     * Constructor
     */
    function BxTeamsPrivacy(&$oModule)
    {
    ...
    /**
     * Check whethere viewer is a member of dynamic team.
     *
     * @param  mixed   $mixedGroupId   dynamic team ID.
